...
import datetime
from dataset_siamese import DogDataset
from model_siamese import DogNet
...
class Config(object):
    ...
    #
    loss = 'swin_large_patch4_window7_224'#focal_loss/CrossEntropyLoss
    accum_iter=2
    verbose=1
    #
    in_channels=3
    ...
    load_from = None
    #
    checkpoints_dir = 'ckpt_0512_byb_AB'
...
if __name__ == '__main__':
    ...
    auc_lst=[]
    shutil.copy('./model_siamese.py',save_dir+'/model_siamese.py')
