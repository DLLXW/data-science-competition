...
parser.add_argument('--model', type=str, default='seresnet152d')#swsl_resnext101_32x8d tf_efficientnet_b4_ns
...
if __name__ == '__main__':
    ...
    for fold, (trn_idx, val_idx) in enumerate(folds):
        ...
        pre_train_path='2021-02-16-10-44/seresnet152d_fold_'+str(fold)+'_best'
        ...
        scheduler = torch.optim.lr_scheduler.CosineAnnealingWarmRestarts(optimizer, T_0=3, T_mult=1, eta_min=args.min_lr, last_epoch=-1)
        ...
        for epoch in range(args.epochs):
            train_one_epoch(epoch, model, criterion, optimizer, train_loader, device, scheduler=None, schd_batch_update=False)
