...
Custom Residual Networks from CSAILVision
"""
...
__all__ = ['ResNet', 'resnet18', 'resnet50', 'resnet101', 'conv3x3', 'BasicBlock', 'Bottleneck']
...
def load_url(url, model_dir='/root/.torch/models', map_location=None):
...
class BasicBlock(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, dilation=1, downsample=None,
                 bn_module=nn.BatchNorm2d, relu_inplace=True):
        super(BasicBlock, self).__init__()
        self.conv1 = conv3x3(inplanes, planes, stride, dilation=dilation)
        self.bn1 = bn_module(planes)
        self.relu = nn.ReLU(inplace=relu_inplace)
        self.relu_inplace = nn.ReLU(inplace=True)
        self.conv2 = conv3x3(planes, planes * self.expansion, dilation=dilation)
        self.bn2 = bn_module(planes * self.expansion)
...
class Bottleneck(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, dilation=1, downsample=None, multi_grid=1,
        ...
        self.bn2 = bn_module(planes)
        self.conv3 = nn.Conv2d(planes, planes * self.expansion, kernel_size=1, bias=False)
        self.bn3 = bn_module(planes * self.expansion)
        self.relu = nn.ReLU(inplace=relu_inplace)
        self.relu_inplace = nn.ReLU(inplace=True)
        self.downsample = downsample
        self.dilation = dilation
...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=1000, bn_module=nn.BatchNorm2d, relu_inplace=False):
        self.inplanes = 128
