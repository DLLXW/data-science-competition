...
train_imgs_dir = os.path.join(data_dir, "images/")
val_imgs_dir = os.path.join(data_dir, "val_images/")

train_labels_dir = os.path.join(data_dir, "labels/")
...
model.load_state_dict(torch.load('./outputs/swin/ckpt/cosine_epoch92.pth'))
