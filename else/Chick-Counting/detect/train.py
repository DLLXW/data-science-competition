...
def parse_opt(known=False):
    ...
    parser.add_argument('--data', type=str, default=ROOT / 'data/chicken.yaml', help='dataset.yaml path')
    ...
    parser.add_argument('--name', default='exp140', help='save to project/name')
