...
# 0.2598   |  4.015    |  3.282    |  0.258    |  6.096    |  10.77    |  0.5037   |  1.542    |  52.11
# 十折训练并保存模型
...
per_flod_num = len(labels) // 10+1

pred = np.zeros([test_data.shape[0],20])
for fold in range(fold_num):
    ...
    gbm = lgb.train(params,lgb_train,num_boost_round=150,valid_sets=lgb_eval, verbose_eval=0)
...
print(pred)
# result=
# test_csv=pd.read_csv('/home/admins/qyl/tianma/data/testA_group8_df.csv')
...
# sub.to_csv("../prediction_single/ep5_bigBert.csv",index=False)
# print(sub)