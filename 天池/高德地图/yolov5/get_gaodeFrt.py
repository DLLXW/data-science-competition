...
import pdb
attention_list=['car','person','bicycle','motorcycle','bus','truck']
fill_null=0
def detect(save_img=False):
            ...
            if det is not None and len(det):
                ...
                for *xyxy, conf, cls in det:
                    ...
                    if obj_name in attention_list:
                        ...
                        if obj_w > 0.85:
                            continue
                        if center_y > 2 * center_y  - 1 and center_y > -2 * center_y + 1:
                            roi_car_cnt += 1
    ...
    df.to_csv('/home/admins/qyl/Yet-Another-EfficientDet-Pytorch/featuresDetect/trainValFeatureYoloV5.csv', index=False)
